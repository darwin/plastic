(ns plastic.frame.handlers
  (:require [plastic.db :refer [app-db]]
            [plastic.frame.utils :refer [first-in-vector]])
...
(defn register-base
  ...
  This is low level and it is expected that \"plastic.frame.core/register-handler\" would
  generally be used."
  ([event-id handler-fn]
