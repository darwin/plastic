(ns quark.frame.handlers
  (:require [quark.db :refer [app-db]]
            [quark.frame.utils :refer [first-in-vector]])
...
(defn register-base
  ...
  This is low level and it is expected that \"quark.frame.core/register-handler\" would
  generally be used."
  ([event-id handler-fn]
